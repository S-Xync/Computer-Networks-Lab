...
void* connection_handler(void* socket_desc){
  ...
  write(connection,sending_buffer,sizeof(sending_buffer));
  memset(sending_buffer,'0',sizeof(sending_buffer));
  snprintf(sending_buffer,sizeof(sending_buffer),"\n1. Upload\n2. Download\n");
